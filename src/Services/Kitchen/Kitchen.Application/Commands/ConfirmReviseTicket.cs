...
public static class ConfirmReviseTicket
{
    public record Command(Guid TicketId, List<RevisedOrderLineItem> RevisedOrderLineItems) : ICommand;
    ...
    public class Handler : ICommandHandler<Command>
    {
        ...
        public async Task Handle(Command command, CancellationToken cancellationToken)
        {
            ...
            var events = ticket.ConfirmReviseTicket(command.RevisedOrderLineItems);
